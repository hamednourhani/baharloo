...
new WPUpdatesThemeUpdater_1606( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1606') ) {
    class WPUpdatesThemeUpdater_1606 {
